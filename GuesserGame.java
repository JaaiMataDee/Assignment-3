...
class Umpire{
	...
	int wantPriceMoney() {
		int input;
		Scanner scan=new Scanner(System.in);
		System.out.println("Do you want Price money");
		 System.out.println("Enter '1' for YES && '2'  for NO");
		 input=scan.nextInt();
		 if(input==1) {
			 System.out.println("Eligible for 1 crore ");
		 }else {
			 System.out.println("Fund goes to charity");
		 }
		 return input;
		}
...
void rewardunlocked() {
	 if(numberOfGuesser==numberOfPlayer1) {
	if (numberOfGuesser==numberOfPlayer2 && numberOfGuesser==numberOfPlayer3) {
	System.out.println("Player 1,Player 2 & Player 3 totally won 1 crore Rupees"); 
	}else if(numberOfGuesser==numberOfPlayer2) {
		System.out.println("Player 1  & Player 2 totally won 1 crore Rupees");
}else if(numberOfGuesser==numberOfPlayer3) {
	System.out.println("Player 1  & Player 3 totally won 1 crore Rupees");
}else {
	System.out.println("Player 1 won 1 crore & Ferrari");
 }
	 }else if(numberOfGuesser==numberOfPlayer2) {
	if (numberOfGuesser==numberOfPlayer3) {
		System.out.println("Player 2 & Player 3 won 1 crore Rupees"); 
		}else {
			System.out.println(" Player 2 won 1 crore & Ferrari");
		}
	 }else if(numberOfGuesser==numberOfPlayer3) {
			System.out.println("Player 3 won 1 crore &  Ferrari");
		}else  {
			System.out.println("All Players Lost!!   $$  1 crore goes to charity$$");
		}
}
}
